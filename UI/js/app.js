 const singleTrackBtn = document.getElementById('track-single-btn');
            ...
            try {
                ...
                resultBox.innerHTML = `
                    <div class="result-header">
                        ...
                        <button class="close-btn" id="close-result">×</button>
                    </div>
                    ...
                    <div class="result-row">
                        ...
                        <span class="result-value">${data.tracking_number}</span>
                    </div>
                    <div class="result-row">
                        <span class="result-label">Origin</span>
                        <span class="result-value">${data.origin}</span>
                    </div>
                    <div class="result-row">
                        <span class="result-label">Destination</span>
                        <span class="result-value">${data.destination}</span>
                    </div>
                `;
                ...
                resultBox.innerHTML = `<p style="color:#dc2626; font-weight:600;">${error.message}</p>`;
                resultBox.style.display = "block";
            } finally {
                singleTrackBtn.disabled = false;
                singleTrackBtn.textContent = "Track Package";
            }
        });
        ...
        startAutomation.addEventListener('click', async () => {
            ...
            try {
                ...
                startAutomation.textContent = 'Start Automation';
            }
        });
